...
private fun VoiceSettingsScreen(
    ...
    fun voiceLabel(voice: android.speech.tts.Voice): String {
        // Android does not expose a universal human voice name/gender API.
        // Show the exact voice ID supplied by the installed TTS engine.
        return voice.name
    }
        ...
        SelectionContainer {
            ...
            DropdownMenu(
                ...
                voicesByLanguage.forEach { (language, languageVoices) ->
                    ...
                    languageVoices.sortedBy { it.name.lowercase(Locale.ROOT) }.forEach { voice ->
                        DropdownMenuItem(
                            text = {
                                Column {
